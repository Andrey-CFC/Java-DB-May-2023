-- drop database exam_prep_first_edition;
create schema exam_prep_first_edition;
use exam_prep_first_edition;
...
-- 4
delete from waiters
where (select count(*) from orders where waiter_id = waiters.id) = 0;
